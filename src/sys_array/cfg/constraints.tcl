...
set_input_delay  7.0 -max -clock [get_clocks clk] [remove_from_collection [all_inputs] [get_ports clk_i]]
set_output_delay 7.0 -max -clock [get_clocks clk] [all_outputs]

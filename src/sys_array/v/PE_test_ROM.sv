...
module PE_test_ROM #(addr_width = 5, data_width = 47) (
    ...
    always_comb case(addr_i)
        ...
        // // Test Overflow // FOR FUTURE
        // // // load weight = 1
        // 31: data_o = {4'b0001, 1'b1, 1'b1, 1'b0, 8'hFF, 32'd1};
        // 32: data_o = {4'b0000, 43'b0}; // wait
        // 33: data_o = {4'b0001, 1'b1, 1'b0, 1'b0, 8'd1, 32'hFFFF_FFFF};
        // 34: data_o = {4'b0010, 1'b1, 1'b0, 1'b0, 8'd1, 32'd0};

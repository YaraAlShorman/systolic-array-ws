...
# Generated on: Fri Mar 13 16:06:01 PDT 2026 (Fri Mar 13 23:06:01 UTC 2026)
...
set logfile fv/systolic_ctrl/rtl_to_fv_map.log
...
read_implementation_information fv/systolic_ctrl -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /home/rmaiti/EE477_VLSI/systolic-array-ws/src/sys_array/v/systolic_ctrl.sv
elaborate_design -golden -root {systolic_ctrl} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/systolic_ctrl/fv_map.v.gz
elaborate_design -revised -root {systolic_ctrl}
...
#add_name_alias fv/systolic_ctrl/fv_map.singlebit.original_name.alias.json.gz -revised
